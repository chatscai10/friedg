        ...
        <CardContent sx={{ flexGrow: 1 }}>
          ...
          >
            ...
            <Box>
              ...
              {item.isSpecial && (
                <Chip label="特選" size="small" color="secondary" sx={{ fontSize: '0.7rem' }} />
              )}
            </Box>
          </Box>
          ...
          <Typography
            ...
            sx={{ height: '40px', overflow: 'hidden', mb: 1 }}
          >
            {item.description || '無描述'}
          </Typography>

          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
            <Chip label={item.categoryName} size="small" variant="outlined" sx={{ mr: 1 }} />
            <Typography
              variant="caption"
              color={
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ display: 'flex', mb: 3, gap: 2 }}>
        ...
        <Button variant="outlined" onClick={fetchMenuItems}>
          套用篩選
        </Button>
      </Box>
